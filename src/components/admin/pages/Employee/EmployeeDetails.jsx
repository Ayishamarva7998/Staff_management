...
const EmployeeDetails = ({ selectedEmployee, setSelectedEmployee }) => {
          ...
          <DialogPanel className="relative w-full max-w-md mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="relative flex flex-col items-center p-6 bg-gray-100">
              ...
              <p className="text-sm text-gray-600 mt-1">
                {selectedEmployee?.email || "Loading..."}
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-600">
                    {selectedEmployee?.position || "Loading..."}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="font-medium text-gray-700">Phone:</span>
                  <span className="text-gray-600">
                    {selectedEmployee?.phone || "Loading..."}
                  </span>
                </div>
